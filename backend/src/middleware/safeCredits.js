/**
 * Safe Credit Enforcement Middleware
 * 
 * Uses SimpleCreditService to avoid startup crashes.
 */

const SimpleCreditService = require('../services/SimpleCreditService');
...
const requireCredits = (operation, options = {}) => {
  return async (req, res, next) => {
    try {
      // Initialize simple credit service
      const creditService = new SimpleCreditService(req.db);
